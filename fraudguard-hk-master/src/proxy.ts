/**
 * Proxy for FraudGuard HK - Next.js 16 replacement for middleware
 * Handles Supabase session refresh and request proxying
 */
...
export async function proxy(request: NextRequest) {
  ...
  // Skip if Supabase is not configured or URL is invalid
